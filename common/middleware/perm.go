...
// import (
// 	"github.com/mooncake9527/orange/modules/sys/models"
// 	"github.com/mooncake9527/orange/modules/sys/service"
// 	"regexp"
// 	"strings"
...
// 		if Error := service.SerSysMenu.CanAccess(c, aid); Error != nil {
// 			Fail(c, 403, "无权限")
// 			return
// 		}
...
// 	res, Error := regexp.MatchString(key2, key1)
// 	if Error != nil {
// 		panic(Error)
// 	}
// 	return res
